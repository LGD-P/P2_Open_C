...
from dl_and_data_to_csv import (
    creat_dir_and_sub_dir,write_books_csv_file, 
    dl_img_in_sub_dir,OUTPUT_FOLDER, 
    IMG_FOLDER,CSV_FOLDER, DATA_TO_SCRAPE)
...
def scrape_all_books(CONSTANT,url_of_every_book):
    ...
    for books in track(url_of_every_book, description="LOAD 1000 books"):
